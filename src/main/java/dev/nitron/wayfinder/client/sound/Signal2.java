...
public class Signal2 extends MovingSoundInstance {
    private final ClientPlayerEntity player;
    private float targetVolume = 0.0F;

    public Signal2(ClientPlayerEntity player) {
        super(ModSounds.SIGNAL_2, SoundCategory.AMBIENT, SoundInstance.createRandom());
        this.player = player;
        this.repeat = true;
        this.repeatDelay = 0;
        this.volume = 0.01F;
    ...
    public void tick() {
        ...
        this.volume = MathHelper.lerp(MinecraftClient.getInstance().getRenderTickCounter().getTickProgress(false), this.volume, targetVolume) * component.getFactor1();
